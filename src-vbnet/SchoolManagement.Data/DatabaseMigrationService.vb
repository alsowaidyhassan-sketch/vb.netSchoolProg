            ...
            Return "
                ...
                BEGIN
                    CREATE TABLE Teachers (
                        ...
                        Email NVARCHAR(100),
                        AssignedSubjects NVARCHAR(255),
                        AssignedClasses NVARCHAR(255),
                ...
                BEGIN
                    CREATE TABLE FeeInvoices (
                        ...
                        OriginalAmount DECIMAL(18, 2) DEFAULT 0,
                        ...
                        StudentId INT,
                        FeeType NVARCHAR(100),
                        FinalAmount DECIMAL(18, 2) NOT NULL CHECK (Amount > 0),
                        PaidAmount DECIMAL(18, 2) DEFAULT 0,
                        DueDate DATE,
                        Status NVARCHAR(50),
                        IsDeleted BIT DEFAULT 0
                ...
                BEGIN
                    CREATE TABLE PaymentReceipts (
                        ...
                        ReceiptNumber NVARCHAR(50) NOT NULL UNIQUE,
                        InvoiceId INT,
                        AmountPaidAmount DECIMAL(18, 2) NOT NULL CHECK (AmountPaid > 0),
